...
Listado.prototype.buscarRestaurante = function(id) {
    return this.restaurantes.find((elem) => {
        return elem.id === id;
    }); 
}

Listado.prototype.filtro = function(queQuieroFiltrar){
    return queQuieroFiltrar.filter(function(elem, index, self) {
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubro = this.restaurantes.map(function (restaurant) {
        return restaurant.rubro;
    });

    var r2 = this.filtro(rubro)
